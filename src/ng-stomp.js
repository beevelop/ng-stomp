...
(function () {
  angular
    ...
    .provider('$stomp', [
      function () {
        var outgoingHeartbeat = 1000
        var incomingHeartbeat = 1000

        return {
          setOutgoingHeartbeat: function (interval) {
            outgoingHeartbeat = interval
          },
          setIncomingHeartbeat: function (interval) {
            incomingHeartbeat = interval
          },
          $get: [
            '$rootScope', '$q',
            function ($rootScope, $q) {
              ...
              this.connect = function (endpoint, headers, errorCallback, sockjsOpts) {
                ...
                this.stomp.heartbeat.outgoing = outgoingHeartbeat
                this.stomp.heartbeat.incoming = incomingHeartbeat
